...
from util import *
from methods import *
from Data.kuramoto import generate_kuramoto_data, generate_dataset_slidingwindow
...
def Data_Generate(args, mode='tracjectory'):
    ...
    if mode=='tracjectory':
        ...
        generate_kuramoto_data(args.trace_num, args.total_t, args.dt, save=True, plot=False, xdim=args.xdim, data_dir=origin_dir)
    ...
    if mode=='id':
        ...
        for tau in T:
            tau = round(tau, 4)
            generate_dataset_slidingwindow(tmp, args.trace_num, tau, is_print=True, data_dir=args.data_dir, start_t=args.start_t, end_t=args.end_t, sliding_length=args.sliding_length, stride_t=args.stride_t)
